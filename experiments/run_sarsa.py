...
def main():
    ...
    # Hyperparameter lists or single overrides
    ...
    for alpha, gamma in itertools.product(alphas, gammas):
        print(f"\nRunning SARSA: episodes={episodes}, num_seeds={args.num_seeds}, α={alpha}, γ={gamma}")
        ...
        for i, seed in enumerate(seeds):
            ...
            for ep in range(episodes):
                # Decay ε linearly from 1.0 down to 0.01
